 ...
 */
public class keyDigitalAndLetterListener extends KeyAdapter {
     ...
     */
    public keyDigitalAndLetterListener(JTextComponent textComponent, int maxLength) {
    ...
    public void keyTyped(KeyEvent e) {
        ...
        if (!Character.isLetterOrDigit(e.getKeyChar()) || e.getKeyChar() == '\u0008' || textComponent.getText().length() >= maxLength) {
