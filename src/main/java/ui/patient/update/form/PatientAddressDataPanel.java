...
public class PatientAddressDataPanel extends JPanel {
    ...
    public PatientAddressDataPanel() {
    ...
    private void createContent() {
        ...
        add(getLabel("Adres:"), gridConstraints);
    ...
    public void fillAddressForm(PatientCard patientCard) {
        String[] splitAddress = ConverterPatientAddress.getSplitAddressInTable(patientCard);
